...
class _ReachUsState extends State<ReachUs> {
  ...
  _launchURLMail() async {
    const url =
        'mailto:nicolas.b.harrell@gmail.com?subject=LifePlusApp&body=Your suggestions%20or Feedback..';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
              ...
              child: GestureDetector(
                onTap: () {
                  setState(() {
                    ...
                    t2.clear();
                    launchUrl(
                        "mailto:nicholas.b.harrell@gmail.com?subject=From $name&body=$message");
                  });
                },
                child: ListTile(
                  title: Row(
